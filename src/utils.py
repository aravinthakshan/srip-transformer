...
def split_data(
    ...
    test_first_mask = (df['year'] >= test_first_years[0]) & (df['year'] <= test_first_years[1])
    test_last_mask = (df['year'] >= test_last_years[0]) & (df['year'] <= test_last_years[1])
